...
class FastBlur(context: Context) {
    ...
    fun getBitmapFromView(view: View): Bitmap? {
        ...
        view.draw(c)
        val resizedBmap = Bitmap.createScaledBitmap(bitmap, bitmap.width / resiz, bitmap.height /resiz, false)
    ...
    fun blur(bitmap: Bitmap): Bitmap? {
        ...
        val allocation: Allocation? = Allocation.createTyped(rs, bitmapType)
